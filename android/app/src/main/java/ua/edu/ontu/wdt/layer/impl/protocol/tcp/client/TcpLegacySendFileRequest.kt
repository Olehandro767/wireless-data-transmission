...
class TcpLegacySendFileRequest(
    ...
    private fun sendFile(
        ...
        val nativeChunkedFileSender =
            TcpNativeChunkedDataSender(socket, this.ioHandler, messageSender.toOutputStream())
    ...
    override fun doRequest() {
        try {
            ...
            Socket(ip, this.context.port).let {
                ...
                val infoWithToken =
                    parseToFileRequestInfoDto(generateFilesInfoWithToken(splitFilesAndFolders))
                ...
                if (messageReader.readBoolMessageFromRemoteDevice()) {
                    ...
                    for (folder in splitFilesAndFolders.folders) {
                        ...
                        messageSender.prepareMessage(true).prepareMessage(folderPath)
                            .sendToRemoteDevice()
                    }
